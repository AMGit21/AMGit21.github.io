    ...
    return (
        <div>
            ...
            <div className='practicalInformationSection'>
                ...
                <p className='justifyText'>{t("Beach clubs in Lebanon are private and with entrance fee. During your stay, you can benefit from a free entrance at Plage des Rois (the usual price is 20$). You can give your name and say you are a guest from our wedding to benefit from that free entrance.")}{t('.')}</p>
                ...
                <p className='justifyText'>{t("Whether it is for Beirut or Byblos, there are a lot of hotels available. You can book through Airbnb or ")}
                    <a href="https://www.booking.com/" rel="noreferrer" target="_blank">www.Booking.com</a>{t('..')}
                ...
                <p className='justifyText'>{t("Please ensure you have deactivated your mobile data before the plane lands; otherwise you might start your trip with a 50$ bill for 15 seconds of internet connection (some will recognize themselves...)")}{t('..')}</p>
