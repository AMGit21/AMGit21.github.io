const fr = {
    ...
    "Welcome to our wedding website! We are so excited to see you all at our wedding in Lebanon! Here you will find all information and details about it. In case you have any question and do not find the answer, feel reach to reach out to us on ": "Bienvenue sur notre site de mariage ! Nous sommes impatients de tous vous retrouver samedi 16 septembre 2023 au Liban pour célébrer ce moment ensemble ! Vous trouverez toutes les informations et détails de notre mariage sur ce site. Si jamais vous avez la moindre question, n'hesitez pas à nous contacter sur ",
    ...
    "Uber works very well in the country with interesting prices. Payments are only made in cash. The Uber driver might request a price higher than what the application says, this is normal: the exchange rate might have changed suddenly and the application did not have time to take it into account. Don't forget that 65,000 Lebanese pounds is only equivalent to 1 dollar...": "Les Ubers fonctionnent très bien avec des prix très intéressants. Les paiements se font uniquement en cash et il arrive que le chauffeur indique un prix un peu plus élevé que celui de l'application : pas d'inquiétude, c'est normal si le taux de change a subitement augmenté, l'application Uber n'a pas encore eu le temps de prendre cela en compte. N'oubliez pas que 65,000 LL ne font qu'un dollar...",
    ...
    "Location: Chez Fouad - Anfeh, Lebanon": "Lieu : Chez Fouad - Anfeh, Liban",
